...
# function findbits(word::Unsigned; n=wordsize(word))
#     a = zeros(Int, n)
#     k = findbits!(a, word)
#     resize!(a, k)
#     return a
# end
# function findbits!(a, word::Unsigned)
#     k = 1
#     for i in 1:wordsize(word)
#         if getbit(word, i)
#             a[k] = i
#             k += 1
#         end
...
#     return k - 1
# end
# function findbits!(a, words)
#     ws = wordsize(eltype(words))
#     k = 1
#     for i in eachindex(words)
#         knew = findbits!(a[k:end], words[i])
#         @views a[k:k+knew] .+= (i-1)*ws
#         k += knew + 1
#     end
#     return k - 1
# end
